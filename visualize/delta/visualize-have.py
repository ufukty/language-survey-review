...
keysOrdered = sorted(dataset["have"], key=lambda lang: dataset["have"][lang][-1], reverse=True)
...
fig.suptitle("Δ(Languages I worked last year / total picks for year)", ha="center")
plt.ylabel('Difference with previous year')
plt.xlabel('Survey years')
plt.savefig(
    fname="visualize/delta/output-have.png",
    dpi=300,
    format=None,
    metadata=None,
    bbox_inches=None,
